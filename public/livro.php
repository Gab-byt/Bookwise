...
<body class="bg-stone-950 text-stone-400">
  <header class="bg-stone-900">
    <nav class="mx-auto max-w-screen-lg flex justify-between items-center py-4">
      <div class="font-bold text-xl tracking-wide text-lime-500">bookwise</div>

      <ul class="flex space-x-6 font-semibold">
        <li><a href="/" class="text-lime-500 hover:underline">Explorar</a></li>
    ...
    ID do livro <?=$livro['$titulo']?>
      <div class="p-2 rounded border-stone-800 border-2 bg-stone-900"> 
            <div class="flex">
                ...
                <div class="space-y-1">
                    <a href="/livro.php?id=<?=$livro['id']?>" class="font-semibold hover:underline"><?=$livro['id']?></a>Título</div>
        ...
        <section class="grid-cols-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <!-- livro -->
        <div class="p-2 rounded border-stone-800 border-2 bg-stone-900"> 
            <div class="flex">
                <div class="w-1/3">imagem</div>
                <div>
                    <a href="/livro.php?" class="font-semibold hover:underline">Título</div>
